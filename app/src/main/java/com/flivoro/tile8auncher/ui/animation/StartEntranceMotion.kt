 ...
 *
 * The first visible band runs for about 2.5 seconds. Later visible bands use
 * a small viewport-relative delay, while the outer 2.8 second envelope gives
 * the last visible band time to settle without an end jump.
 */
internal object StartEntranceMotion {
    ...
    // The short early samples follow the measured growth and fade. The later
    // samples preserve the long horizontal deceleration tail.
